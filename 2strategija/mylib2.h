...
void rusiavimas2Vector(const vector<Studentas>& studentai, vector<Studentas>& vargsiukai, int skaiciux);
...
void rusiavimas2List(const list<Studentas2>& studentai2, list<Studentas2>& vargsiukai, int skaiciux);
